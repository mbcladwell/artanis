...
ENV         LANG C.UTF-8
RUN     apt-get update \
        && apt-get install --no-install-recommends -y texinfo guile-3.0 guile-3.0-dev build-essential automake git autoconf libtool default-libmysqlclient-dev libmariadbd-dev libnss3 libnss3-dev redis redis-server \
